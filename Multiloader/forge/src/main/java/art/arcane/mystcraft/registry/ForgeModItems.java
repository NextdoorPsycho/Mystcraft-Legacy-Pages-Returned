...
public final class ForgeModItems {
    ...
    public static final RegistryObject<Item> PAGE =
            MystcraftRegistries.ITEMS.register("page",
                    () -> new ForgePageItem(new Item.Properties().stacksTo(64)));
    ...
    public static final RegistryObject<Item> INK_BUCKET =
            MystcraftRegistries.ITEMS.register("ink_bucket",
                    () -> new BucketItem(ForgeModFluids.BLACK_INK_SOURCE,
                            new Item.Properties().stacksTo(1).craftRemainder(Items.BUCKET)));

    // Block items - auto-generated for each block
    public static final RegistryObject<Item> INK_MIXER_ITEM = blockItem("blockinkmixer", ForgeModBlocks.INK_MIXER);
    ...
    public static final RegistryObject<Item> DECAY_ITEM = blockItem("blockdecay", ForgeModBlocks.DECAY);
