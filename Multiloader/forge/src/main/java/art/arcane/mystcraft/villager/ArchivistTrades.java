...
public final class ArchivistTrades {
    ...
    public static void onVillagerTrades(VillagerTradesEvent event) {
        ...
        level1.add(new BasicItemListing(
                ...
                new ItemStack(ForgeModItems.INK_VIAL.get(), 1),
                12, 1, 0.05f
        ));
        level1.add(new BasicItemListing(
                new ItemStack(ForgeModItems.PAGE.get(), 8),
                new ItemStack(Items.EMERALD, 1),
                16, 2, 0.05f
        ));
        level1.add(new BasicItemListing(
                new ItemStack(Items.EMERALD, 1),
                new ItemStack(ForgeModItems.PAGE.get(), 4),
                16, 1, 0.05f
        ));
        ...
        level2.add(new BasicItemListing(
                ...
                new ItemStack(ForgeModItems.FOLDER.get(), 1),
                8, 5, 0.05f
        ));
        level2.add(new BasicItemListing(
                new ItemStack(Items.EMERALD, 3),
                new ItemStack(ForgeModItems.INK_VIAL.get(), 2),
                12, 5, 0.05f
        ));
        ...
        level3.add(new BasicItemListing(
                ...
                new ItemStack(ForgeModItems.PORTFOLIO.get(), 1),
                4, 10, 0.05f
        ));
        level3.add(new BasicItemListing(
                new ItemStack(Items.EMERALD, 8),
                new ItemStack(ForgeModItems.BOOSTER_PACK.get(), 1),
                6, 10, 0.05f
        ));
        ...
        level4.add(new BasicItemListing(
                ...
                new ItemStack(ForgeModItems.LINKBOOK_UNLINKED.get(), 1),
                3, 15, 0.05f
        ));
        level4.add(new BasicItemListing(
                new ItemStack(Items.EMERALD, 16),
                new ItemStack(ForgeModItems.GLASSES.get(), 1),
                3, 15, 0.05f
        ));
        ...
        level5.add(new BasicItemListing(
                new ItemStack(ForgeModItems.LINKBOOK.get(), 1),
