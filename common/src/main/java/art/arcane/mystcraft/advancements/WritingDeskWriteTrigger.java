...
/**
 * Triggers when a player writes a symbol at the writing desk.
 */
public class WritingDeskWriteTrigger extends SimpleCriterionTrigger<WritingDeskWriteTrigger.TriggerInstance> {
