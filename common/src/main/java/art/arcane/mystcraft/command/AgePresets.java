  ...
  static {
    ...
    register(new Preset("rainbow", "Rainbow Prism",
        list("mystcraft:terrain_stripes", "mystcraft:biome_small",
            ...
            // Randomized color targets (no fixed color stack) for variety per Age
            "mystcraft:color_grass", "mystcraft:color_grass",
            "mystcraft:color_grass", "mystcraft:color_grass",
            "mystcraft:color_grass", "mystcraft:color_grass",
            "mystcraft:color_foliage", "mystcraft:color_foliage",
            "mystcraft:color_foliage", "mystcraft:color_foliage",
            "mystcraft:color_sky",
            "mystcraft:color_sky_night",
            "mystcraft:color_fog",
            "mystcraft:color_water",
            "mystcraft:color_cloud",
            "mystcraft:color_sunset",
            "mystcraft:color_horizon",
            "mystcraft:rainbow", "mystcraft:gradient_aurora",
