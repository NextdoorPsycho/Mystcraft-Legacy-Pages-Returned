...
public final class TerrainGeneratorRegistry {
  ...
  private static final Map<ResourceLocation, TerrainGeneratorFactory> FACTORIES = new HashMap<>();

  private TerrainGeneratorRegistry() {
  }

  public static void register(ResourceLocation id, TerrainGeneratorFactory factory) {
  ...
  public static ITerrainGenerator create(ResourceLocation id, AgeDirector director, long seed, JsonObject json) {
  ...
  public static Map<ResourceLocation, TerrainGeneratorFactory> getAll() {
