 ...
 * <p>
 * 1.20.x: Uses {@code Component.literal("text")}, {@code Component.translatable("key")}
 * 1.19.x: Uses {@code new TextComponent("text")}, {@code new TranslatableComponent("key")}
 */
public interface IComponentHelper {
   ...
   * <p>
   * 1.20.x: {@code Component.literal(text)}
   * 1.19.x: {@code new TextComponent(text)}
   *
   ...
   * <p>
   * 1.20.x: {@code Component.empty()}
   * 1.19.x: {@code TextComponent.EMPTY}
   *
   ...
   * <p>
   * 1.20.x: {@code Component.translatable(key)}
   * 1.19.x: {@code new TranslatableComponent(key)}
   *
   ...
   * <p>
   * 1.20.x: {@code Component.translatable(key, args)}
   * 1.19.x: {@code new TranslatableComponent(key, args)}
   *
   * @param key  The translation key
