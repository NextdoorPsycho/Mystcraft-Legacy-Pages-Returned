...
public final class AgeSeed {
  ...
  public static OptionalLong read(@NotNull ItemStack stack) {
    ...
    if (tag == null || !tag.contains(TAG_SEED, Tag.TAG_ANY_NUMERIC)) {
      return OptionalLong.empty();
    }
    return OptionalLong.of(tag.getLong(TAG_SEED));
  }
   ...
   */
  @NotNull
  public static List<ResourceLocation> symbolIdsFromPages(@NotNull List<ItemStack> pages) {
   ...
   */
  public static long deriveFromSymbolIds(@NotNull List<ResourceLocation> symbolIds) {
