...
public class ClockworkRuinsPopulator implements IPopulate {
  ...
  private static final BlockState COPPER = Blocks.COPPER_BLOCK.defaultBlockState();
  private static final BlockState EXPOSED_COPPER = Blocks.EXPOSED_COPPER.defaultBlockState();
  private static final BlockState WEATHERED_COPPER = Blocks.WEATHERED_COPPER.defaultBlockState();
  private static final BlockState OXIDIZED_COPPER = Blocks.OXIDIZED_COPPER.defaultBlockState();
  private static final BlockState CUT_COPPER = Blocks.CUT_COPPER.defaultBlockState();
  ...
  private static final BlockState LIGHTNING_ROD = Blocks.LIGHTNING_ROD.defaultBlockState();
  ...
  public void populate(WorldGenLevel world, RandomSource random, BlockPos chunkPos) {
    for (int i = 0; i < count; i++) {
      ...
      if (surfaceY <= world.getMinBuildHeight() + 5 || surfaceY >= world.getMaxBuildHeight() - MAX_SIZE - 10) {
        continue;
      }
