...
/**
 * Fabric 1.18.2 version of EnterMystDimensionSafeTrigger.
 * Uses the older API with EntityPredicate.Composite (no Optional) and getId().
 */
public class EnterMystDimensionSafeTrigger_1_18_2 extends SimpleCriterionTrigger<EnterMystDimensionSafeTrigger_1_18_2.TriggerInstance> {
