...
public class MeteorEntityRenderer extends EntityRenderer<MeteorEntity> {
  ...
  public void render(@NotNull MeteorEntity entity, float entityYaw, float partialTick,
    ...
    poseStack.mulPose(Vector3f.YP.rotationDegrees(tumble));
    poseStack.mulPose(Vector3f.XP.rotationDegrees(tumble * 0.7f));
    poseStack.mulPose(Vector3f.ZP.rotationDegrees(tumble * 0.3f));
