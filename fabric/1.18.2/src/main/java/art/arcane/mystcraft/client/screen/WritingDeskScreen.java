...
public class WritingDeskScreen extends FlooContainerScreen<WritingDeskMenu> {
  ...
  protected void init() {
    ...
    sortAzButton.setTooltip(List.of(new TextComponent("Sort Alphabetically")));
    ...
    showAllButton.setTooltip(List.of(new TextComponent("Show all Symbols")));
  ...
  private void renderSymbolCostIndicator(PoseStack poseStack, int mouseX, int mouseY) {
    ...
    // Symbol name
    costTooltip.add(new TextComponent(hoveredSymbol.getLocalizedName())
        .withStyle(ChatFormatting.AQUA));

    // Category
    SymbolCategory category = hoveredSymbol.getCategory();
    if (category != null) {
      costTooltip.add(new TextComponent("Category: " + category.name())
          .withStyle(ChatFormatting.GRAY));
    }

    costTooltip.add(new TextComponent(""));
    ...
    costTooltip.add(new TextComponent("Ink Cost: ")
        .withStyle(ChatFormatting.GRAY)
        .append(new TextComponent(inkCost + " mB")
            .withStyle(inkColor)));
    ...
    costTooltip.add(new TextComponent("Instability: ")
        .withStyle(ChatFormatting.GRAY)
        .append(new TextComponent(String.format("%+.1f", instability))
    ...
    if (rank != null && rank > 0) {
      ...
      costTooltip.add(new TextComponent("Rank: ")
          .withStyle(ChatFormatting.GRAY)
          .append(new TextComponent(rankStars)
              .withStyle(rankColor)));
    }
    ...
    if (currentInk < inkCost) {
      costTooltip.add(new TextComponent(""));
      costTooltip.add(new TextComponent("Not enough ink!")
