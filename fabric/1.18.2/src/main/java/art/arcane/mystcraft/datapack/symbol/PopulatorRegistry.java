 ...
 * Ported to Fabric 1.18.2: Uses Registry.BLOCK (same as Forge 1.18.2)
 */
public final class PopulatorRegistry {
  ...
  public static void registerDefaults() {
    // Terrain populators - available in 1.18.2
    ...
    // Ore populators - available in 1.18.2
    ...
    // TODO: Port these populators to 1.18.2 when needed:
    // - DenseOresPopulator
    // - HugeTreePopulator
    // - DripstoneCavesPopulator
    // - LushCavesPopulator
    // - DeepDarkPopulator (1.19+ only - contains Sculk)
    ...
    // - AncientCitiesPopulator (1.19+ only)
