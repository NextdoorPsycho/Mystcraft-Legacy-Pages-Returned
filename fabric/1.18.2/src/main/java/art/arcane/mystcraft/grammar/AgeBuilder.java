 ...
 * <p>
 * 1.18.2 version - removed blocks that don't exist in 1.18.2 (PACKED_MUD, MUD_BRICKS, MANGROVE_PLANKS, SCULK).
 */
public class AgeBuilder {
  ...
  // 1.18.2: Removed blocks that don't exist - PACKED_MUD, MUD_BRICKS, MANGROVE_PLANKS, SCULK
  ...
  private static final Block[] CAVE_BLOCKS = {
      ...
      Blocks.MOSS_BLOCK, Blocks.SMOOTH_BASALT,
