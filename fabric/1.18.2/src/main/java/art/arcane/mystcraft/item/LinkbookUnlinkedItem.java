...
public class LinkbookUnlinkedItem extends Item {
  ...
  public static ItemStack createItem(@NotNull ItemStack linkpanel, @NotNull ItemStack covermat) {
    ItemStack linkbook = new ItemStack(FabricRegistries.LINKBOOK_UNLINKED.get());
  ...
  public InteractionResultHolder<ItemStack> use(@NotNull Level level, @NotNull Player player, @NotNull InteractionHand hand) {
    ...
    ItemStack linkBook = new ItemStack(FabricRegistries.LINKBOOK.get());
  ...
  // Note: hasCustomEntity and createEntity are Forge-specific in 1.18.2
  // For Fabric, item entity customization is handled differently
}
