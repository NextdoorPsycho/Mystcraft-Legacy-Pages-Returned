 ...
 * <p>
 * 1.18.2 version using java.util.Random instead of RandomSource.
 */
public final class SymbolRegistry {
   ...
   *
   * @param category The category
   * @param random   The random source (java.util.Random for 1.18.2)
   * @return A random symbol, or null if category is empty
   */
  public static IAgeSymbol getRandomFromCategory(SymbolCategory category, Random random) {
    List<IAgeSymbol> list = BY_CATEGORY.get(category);
   ...
   */
  public static IAgeSymbol getRandomWeighted(Random random) {
