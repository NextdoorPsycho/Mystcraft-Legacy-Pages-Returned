 ...
 * Does not include CHERRY_GROVE or BAMBOO_JUNGLE biomes (1.19+ only).
 */
public class TerrainGeneratorNormal extends TerrainGeneratorBase {
  ...
  static {
    ...
    // Jungle biomes (no BAMBOO_JUNGLE in 1.18.2)
    ...
    // Swamp biomes (no MANGROVE_SWAMP in 1.18.2)
    ...
    // No DEEP_DARK or CHERRY_GROVE in 1.18.2
  ...
  public TerrainGeneratorNormal(AgeDirector controller, long seed, boolean amplified) {
    ...
    random = new Random(seed); // Reset for noiseGen5
