...
/**
 * Fabric client entry point for Mystcraft 1.19.2.
...
public class MystcraftFabricClient implements ClientModInitializer {
  ...
  public void onInitializeClient() {
    Mystcraft.LOGGER.info("[Mystcraft] Client setup (1.19.2)");
    ...
    // PageItemRendererBEWLR excluded in 1.19.2 - uses ItemDisplayContext which doesn't exist
    ...
    // BEWLR for page item excluded in 1.19.2 - uses ItemDisplayContext which doesn't exist
    // Page items will render with default item rendering
  }
}
