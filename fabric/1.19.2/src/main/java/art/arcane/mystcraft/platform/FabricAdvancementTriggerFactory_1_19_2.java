...
import art.arcane.mystcraft.advancements.trigger.EnterMystDimensionQuinnTrigger_1_19_2;
import art.arcane.mystcraft.advancements.trigger.EnterMystDimensionSafeTrigger_1_19_2;
import art.arcane.mystcraft.advancements.trigger.WritingDeskWriteTrigger_1_19_2;
...
/**
 * Fabric 1.19.2 implementation of advancement trigger factory.
 * Uses the older API with ContextAwarePredicate (no Optional) and getId().
 */
public class FabricAdvancementTriggerFactory_1_19_2 implements IAdvancementTriggerFactory {

  private WritingDeskWriteTrigger_1_19_2 writingDeskWriteTrigger;
  private EnterMystDimensionSafeTrigger_1_19_2 enterMystDimensionSafeTrigger;
  private EnterMystDimensionQuinnTrigger_1_19_2 enterMystDimensionQuinnTrigger;
  ...
  private static Method findRegisterMethod() throws NoSuchMethodException {
    ...
    // 1.19.2 uses register(CriterionTrigger) where the trigger has getId()
    ...
    // Fallback: try 2-param version (shouldn't be needed for 1.19.2)
    for (Method method : methods) {
      Class<?>[] params = method.getParameterTypes();
      if (params.length != 2) {
        continue;
  ...
  public CriterionTrigger<?> createEnterMystDimensionSafeTrigger() {
    return new EnterMystDimensionSafeTrigger_1_19_2();
  }

  @Override
  public CriterionTrigger<?> createEnterMystDimensionQuinnTrigger() {
    return new EnterMystDimensionQuinnTrigger_1_19_2();
  }

  @Override
  public CriterionTrigger<?> createWritingDeskWriteTrigger() {
    return new WritingDeskWriteTrigger_1_19_2();
  }

  @Override
  public void registerTriggers() {
    writingDeskWriteTrigger = new WritingDeskWriteTrigger_1_19_2();
    enterMystDimensionSafeTrigger = new EnterMystDimensionSafeTrigger_1_19_2();
    enterMystDimensionQuinnTrigger = new EnterMystDimensionQuinnTrigger_1_19_2();
    ...
    try {
      ...
      if (params.length == 1) {
        // 1.19.2 style: register(CriterionTrigger) - trigger has getId()
