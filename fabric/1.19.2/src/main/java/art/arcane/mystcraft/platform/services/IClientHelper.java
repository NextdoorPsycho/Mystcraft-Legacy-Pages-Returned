...
/**
 * Abstracts client-side registration operations - 1.19.2 version using PoseStack.
...
public interface IClientHelper {
   ...
   * @param poseStack   The PoseStack context (1.19.2 uses PoseStack, not GuiGraphics)
   ...
   * <p>
   * In 1.19.2: passes (mouseX, mouseY, scrollDelta) - scrollDelta combines X and Y
   *
   * @param scrollX Horizontal scroll amount (0 in 1.19.2)
   * @param scrollY Vertical scroll amount (scrollDelta in 1.19.2)
