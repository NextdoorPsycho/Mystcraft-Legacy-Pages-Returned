...
/**
 * Fabric GameTest wrapper that forwards loader-discovered tests into the shared runner.
 */
public class MystcraftFabricGameTests implements FabricGameTest {
  ...
  @GameTest(template = FabricGameTest.EMPTY_STRUCTURE, batch = MystcraftGameTestSuites.BOOK_TRAVEL, timeoutTicks = 200)
  ...
  @GameTest(template = FabricGameTest.EMPTY_STRUCTURE, batch = MystcraftGameTestSuites.BOOK_TRAVEL, timeoutTicks = 60)
  ...
  @GameTest(template = FabricGameTest.EMPTY_STRUCTURE, batch = MystcraftGameTestSuites.BOOK_TRAVEL, timeoutTicks = 80)
  ...
  @GameTest(template = FabricGameTest.EMPTY_STRUCTURE, batch = MystcraftGameTestSuites.PROCEDURAL_UI, timeoutTicks = 40)
