...
public class StarFissurePopulator implements IPopulate {
  ...
  public void populate(WorldGenLevel world, Random random, BlockPos chunkPos) {
    ...
    Random chunkRandom = chunkRandom(chunkX, chunkZ);
  ...
  private void generateStarFissure(WorldGenLevel world, Random random, BlockPos centerPos) {
  ...
  private void addJaggedEdge(WorldGenLevel world, Random random, BlockPos edgePos, int top, int bottom) {
  ...
  private void addStarFissureBlocks(WorldGenLevel world, Random random, BlockPos centerPos,
  ...
  public void forceGenerate(WorldGenLevel world, BlockPos centerPos) {
    ...
    chunkMinZ = chunkZ << 4;
    chunkMaxZ = chunkMinZ + 15;
    Random rand = chunkRandom(chunkX, chunkZ);
