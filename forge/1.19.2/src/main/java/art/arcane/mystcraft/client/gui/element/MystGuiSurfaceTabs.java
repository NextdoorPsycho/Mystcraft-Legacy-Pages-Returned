...
public class MystGuiSurfaceTabs extends MystGuiElement {
  ...
  protected void doRenderBackground(PoseStack poseStack, float partialTick, int mouseX, int mouseY) {
    ...
    GuiComponent.drawCenteredString(poseStack, mc.font, Component.literal("^"), guiLeft + TAB_WIDTH / 2, tabY + 1, upArrowColor);
    tabY += ARROW_HEIGHT;
    ...
    GuiComponent.fill(poseStack, guiLeft, tabY, guiLeft + TAB_WIDTH, tabY + ARROW_HEIGHT, 0xFF303030);
    GuiComponent.drawCenteredString(poseStack, mc.font, Component.literal("v"), guiLeft + TAB_WIDTH / 2, tabY + 1, downArrowColor);
  }
