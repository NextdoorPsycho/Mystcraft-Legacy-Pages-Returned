 ...
 * Ported to 1.19.2: player.serverLevel() -> player.getLevel() (already ServerLevel in 1.19.2)
 */
public class AgeDataSyncHandler {
  ...
  public static void onPlayerChangeDimension(ServerPlayer player) {
    // 1.19.2: ServerPlayer.getLevel() already returns ServerLevel
    ServerLevel toLevel = player.getLevel();
  ...
  public static void syncAgeDataToPlayer(ServerPlayer player, ServerLevel ageLevel) {
    ...
    List<Integer> grassColors = ageData.getGrassColors();
