...
public final class MystcraftGameTestAssertions {
   ...
   * Note: In 1.19.2, creative tabs are not in a registry, so we skip this check.
   */
  public static void assertCreativeTabsLoaded() {
    // Creative tabs are handled differently in 1.19.2 - they're not in a registry
    // This is a no-op for 1.19.2 compatibility
  }
