...
/**
 * Network handler for Mystcraft packets on Forge 1.19.2.
 * Uses Forge's SimpleChannel for client-server communication.
 * <p>
 * This is the 1.19.2-specific implementation using the old NetworkRegistry API.
 */
public final class ForgeMystcraftNetwork_1_19_2 {
  ...
  private ForgeMystcraftNetwork_1_19_2() {
  }
  ...
  private static <T> BiConsumer<T, Supplier<NetworkEvent.Context>> wrap(BiConsumer<T, PacketContext> handler) {
    return (packet, ctxSupplier) -> {
      ...
      handler.accept(packet, new ForgePacketContext_1_19_2(ctx));
  ...
  public static void register() {
    ...
    // 1.19.2: ConfigSyncPacket, DimensionSyncPacket, ProfilingStatePacket, ExplosionPacket, SpawnLightningPacket not ported
    ...
    // 1.19.2: PocketHeadSyncPacket not ported
