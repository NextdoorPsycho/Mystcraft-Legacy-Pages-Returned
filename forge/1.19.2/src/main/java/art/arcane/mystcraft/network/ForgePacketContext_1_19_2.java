 ...
 * This is the 1.19.2-specific implementation.
 */
public class ForgePacketContext_1_19_2 implements PacketContext {

  private final NetworkEvent.Context ctx;

  public ForgePacketContext_1_19_2(NetworkEvent.Context ctx) {
    this.ctx = ctx;
  }
