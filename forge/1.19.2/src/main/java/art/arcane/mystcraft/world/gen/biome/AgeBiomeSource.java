...
public class AgeBiomeSource extends BiomeSource {
  ...
  public AgeBiomeSource(IBiomeController controller, long seed) {
    // 1.19.2 requires a biome stream in the constructor
  ...
  // Note: In 1.19.2, collectPossibleBiomes() doesn't exist as an override.
  // Biomes are provided via super constructor with Stream<Holder<Biome>>.
