 ...
 */
public abstract class ForgeBlackInkFluid extends ForgeFlowingFluid {

  private static Supplier<FluidType> fluidTypeSupplier;

  protected ForgeBlackInkFluid(Properties properties) {
    super(properties);
  }
   ...
   */
  public static class Source extends ForgeBlackInkFluid {
   ...
   */
  public static class Flowing extends ForgeBlackInkFluid {
