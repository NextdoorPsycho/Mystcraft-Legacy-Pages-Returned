...
/**
 * Forge 1.20.2 implementation of advancement trigger factory.
 * Uses the newer API with Optional<ContextAwarePredicate> and no getId() requirement.
 */
public class ForgeAdvancementTriggerFactory_1_20_2 implements IAdvancementTriggerFactory {
