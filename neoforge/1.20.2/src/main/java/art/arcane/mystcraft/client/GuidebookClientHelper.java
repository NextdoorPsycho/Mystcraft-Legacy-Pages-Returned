...
/**
 * Client-side helper for opening the guidebook screen.
 * This class is only loaded via reflection from GuidebookItem when on the client side.
 * It should never be loaded on a dedicated server.
 */
