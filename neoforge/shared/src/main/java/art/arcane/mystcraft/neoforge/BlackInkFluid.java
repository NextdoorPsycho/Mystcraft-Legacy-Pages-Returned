...
public abstract class BlackInkFluid extends BaseFlowingFluid {
  ...
  public static BaseFlowingFluid.Properties createProperties() {
    return new BaseFlowingFluid.Properties(
        NeoForgeRegistries.BLACK_INK_TYPE,
        NeoForgeRegistries.BLACK_INK_SOURCE,
        NeoForgeRegistries.BLACK_INK_FLOWING
    )
        .slopeFindDistance(2)
        .levelDecreasePerBlock(2)
        .block(NeoForgeRegistries.FLUID_INK)
        .bucket(NeoForgeRegistries.INK_BUCKET);
  }

  @Override
  public FluidType getFluidType() {
    return NeoForgeRegistries.BLACK_INK_TYPE.get();
  }
