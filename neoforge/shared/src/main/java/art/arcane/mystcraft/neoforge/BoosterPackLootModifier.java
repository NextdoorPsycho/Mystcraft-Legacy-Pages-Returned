...
public class BoosterPackLootModifier extends LootModifier {
  ...
  public static final Supplier<MapCodec<BoosterPackLootModifier>> CODEC = Suppliers.memoize(() ->
  ...
  protected @NotNull ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
    ...
    ItemStack boosters = new ItemStack(NeoForgeRegistries.BOOSTER_PACK.get(), count);
