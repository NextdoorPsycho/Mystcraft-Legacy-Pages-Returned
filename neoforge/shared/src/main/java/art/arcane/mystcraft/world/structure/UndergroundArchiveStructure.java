 ...
 * NeoForge 1.20.6+ version with MapCodec for StructureType registry.
 */
public class UndergroundArchiveStructure extends Structure {

  public static final MapCodec<UndergroundArchiveStructure> CODEC = RecordCodecBuilder.mapCodec(instance ->
      instance.group(
