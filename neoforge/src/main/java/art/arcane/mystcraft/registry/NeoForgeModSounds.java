...
public final class NeoForgeModSounds {
    ...
    // Linking sounds
    public static final DeferredHolder<SoundEvent, SoundEvent> LINKING_POP =
            registerSound("linking.pop");

    public static final DeferredHolder<SoundEvent, SoundEvent> LINKING_LINK =
            registerSound("linking.link");

    public static final DeferredHolder<SoundEvent, SoundEvent> LINKING_DISARM =
            registerSound("linking.link-disarm");

    public static final DeferredHolder<SoundEvent, SoundEvent> LINKING_FOLLOWING =
            registerSound("linking.link-following");

    public static final DeferredHolder<SoundEvent, SoundEvent> LINKING_INTRA =
            registerSound("linking.link-intra");

    public static final DeferredHolder<SoundEvent, SoundEvent> LINKING_FISSURE =
            registerSound("linking.link-fissure");

    public static final DeferredHolder<SoundEvent, SoundEvent> LINKING_PORTAL =
            registerSound("linking.link-portal");

    // Meteor sounds
    public static final DeferredHolder<SoundEvent, SoundEvent> METEOR_ROAR =
