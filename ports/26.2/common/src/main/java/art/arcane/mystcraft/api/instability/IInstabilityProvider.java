...
/**
 * Interface for providing instability effects. Implementations create and
 * register environmental effects based on instability level.
 */
public interface IInstabilityProvider {
   ...
   * @param level    The activation level (number of times this provider's card
   *                 was drawn)
   */
