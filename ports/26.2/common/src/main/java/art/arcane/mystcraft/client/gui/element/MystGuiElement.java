...
public abstract class MystGuiElement {
  ...
  public void renderBackground(GuiGraphicsExtractor graphics, float partialTick, int mouseX, int mouseY) {
    if (!visible) return;
  ...
  protected void doRenderBackground(GuiGraphicsExtractor graphics, float partialTick, int mouseX, int mouseY) {
  }
  ...
  protected void doRenderForeground(GuiGraphicsExtractor graphics, int mouseX, int mouseY) {
  }
