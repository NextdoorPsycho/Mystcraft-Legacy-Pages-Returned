...
public final class BookItemTextureFactory {
  ...
  /**
   * Returns a {@link Identifier} for the closed-book icon texture,
   * generating and caching it if not already present.
   */
  @NotNull
  public static Identifier getItemTexture(@NotNull ItemStack stack) {
  ...
  private static void drawIconGrain(NativeImage image, int x, int y, int w, int h,
                                    int base, int accent, CoverPalette.Grain grain, Identifier seedSrc) {
