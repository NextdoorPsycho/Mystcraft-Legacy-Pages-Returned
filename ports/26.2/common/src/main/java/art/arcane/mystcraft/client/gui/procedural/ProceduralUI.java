 ...
 * <p>
 * All methods consume a {@link GuiGraphicsExtractor} and draw immediately at screen
...
public final class ProceduralUI {
   ...
   */
  public static void drawRaisedBorder(@NotNull GuiGraphicsExtractor g, int x, int y, int w, int h) {
   ...
   */
  public static void drawInsetBorder(@NotNull GuiGraphicsExtractor g, int x, int y, int w, int h) {
    int dark = GuiTheme.color("panel_border_dark");
    int light = GuiTheme.color("panel_border_light");
   ...
   */
  public static void drawPanel(@NotNull GuiGraphicsExtractor g, int x, int y, int w, int h) {
   ...
   */
  public static void drawTitleBar(@NotNull GuiGraphicsExtractor g, Font font, @NotNull Component title,
    ...
    g.text(font, title, textX, textY, titleText, false);
  }

  /**
   * Draws a horizontal 1-pixel divider line.
   */
  public static void drawHorizontalDivider(@NotNull GuiGraphicsExtractor g, int x, int y, int w) {
   ...
   */
  public static void drawSlot(@NotNull GuiGraphicsExtractor g, int x, int y) {
   ...
   */
  public static void drawSlot(@NotNull GuiGraphicsExtractor g, int x, int y, int w, int h) {
   ...
   */
  public static void drawSlotGrid(@NotNull GuiGraphicsExtractor g, int x, int y, int cols, int rows, int spacing) {
    int slot = 18;
   ...
   */
  public static void drawPaperBackground(@NotNull GuiGraphicsExtractor g, int x, int y, int w, int h) {
   ...
   */
  public static void drawLeatherGrain(@NotNull GuiGraphicsExtractor g, int x, int y, int w, int h, int baseColor) {
   ...
   */
  public static void drawWoodGrain(@NotNull GuiGraphicsExtractor g, int x, int y, int w, int h, int baseColor) {
    g.fill(x, y, x + w, y + h, baseColor);
   ...
   */
  public static void drawWarningGlyph(@NotNull GuiGraphicsExtractor g, int x, int y, int w, int h) {
    drawWarningGlyph(g, x, y, w, h, 1.0F);
  }

  /** Draws a warning glyph with an extraction-safe alpha multiplier. */
  public static void drawWarningGlyph(@NotNull GuiGraphicsExtractor g, int x, int y, int w, int h,
                                      float alpha) {
    int channel = Math.max(0, Math.min(255, Math.round(alpha * 255.0F)));
    int border = channel << 24 | 0x202020;
    int fill = channel << 24 | 0xFFCC22;
    int center = channel << 24 | 0x3A2A04;
   ...
   */
  public static void drawChevron(@NotNull GuiGraphicsExtractor g, int x, int y, int size, @NotNull ChevronDir dir, int color) {
   ...
   * Pixel-perfect at small radii; uses {@link GuiGraphicsExtractor#fill} for each row.
   */
  public static void drawDisc(@NotNull GuiGraphicsExtractor g, int centerX, int centerY, int radius, int color) {
   ...
   * {@link #drawDisc}.
   */
  public static void drawRing(@NotNull GuiGraphicsExtractor g, int centerX, int centerY, int radius, int color) {
   ...
   */
  public static void drawBasin(@NotNull GuiGraphicsExtractor g, int centerX, int centerY, int radius) {
