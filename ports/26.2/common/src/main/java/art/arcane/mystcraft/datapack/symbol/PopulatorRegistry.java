...
public final class PopulatorRegistry {
  ...
  private static final Map<Identifier, PopulatorFactory> FACTORIES = new HashMap<>();

  private PopulatorRegistry() {
  }

  public static void register(Identifier id, PopulatorFactory factory) {
  ...
  public static IPopulate create(Identifier id, JsonObject json, long seed) {
  ...
  public static Map<Identifier, PopulatorFactory> getAll() {
