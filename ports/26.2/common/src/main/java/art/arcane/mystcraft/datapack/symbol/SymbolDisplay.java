...
public record SymbolDisplay(@Nullable String motifName,
   ...
   */
  @Nullable
  public static SymbolDisplay fromJson(@NotNull Identifier symbolId, @Nullable JsonElement element) {
  ...
  @Nullable
  private static PaletteOverride parsePaletteOverride(@NotNull Identifier symbolId, @NotNull JsonObject json) {
  ...
  @Nullable
  private static Integer parseColor(@NotNull Identifier symbolId,
  ...
  @NotNull
  private static Map<String, Integer> parseGlyphSeeds(@NotNull Identifier symbolId, @NotNull JsonObject json) {
  ...
  @Nullable
  private static Integer parseSeedValue(@NotNull Identifier symbolId,
