...
public final class SymbolLogicTypes {
  ...
  private record SimpleStringType(Identifier id,
    ...
    private SimpleStringType(String id, BiConsumer<AgeDirector, String> setter) {
      this(Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, id), setter);
    }
  ...
  private record SimpleIntType(Identifier id,
    ...
    private SimpleIntType(String id, BiConsumer<AgeDirector, Integer> setter,
                          BiConsumer<AgeDirector, Boolean> naturalSetter) {
      this(Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, id), setter, naturalSetter);
    }
  ...
  private record SimpleFloatType(Identifier id,
  ...
  private record SimpleBooleanType(Identifier id,
  ...
  private static class AddInstabilityType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "add_instability");
  ...
  private static class SetFlagType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "set_flag");
  ...
  private static class SetStarFissureType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "set_star_fissure");
  ...
  private static class SetTerrainBlockType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "set_terrain_block");
    ...
    @Override
    public SymbolLogic parse(JsonObject json) {
      Identifier blockId = Identifier.tryParse(GsonHelper.getAsString(json, "block"));
      return (director, seed) -> {
  ...
  private static class SetSeaBlockType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "set_sea_block");
  ...
  private static class RegisterPopulatorType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "register_populator");
    ...
    public SymbolLogic parse(JsonObject json) {
      ...
      Identifier popId = Identifier.tryParse(rawId);
      JsonObject params = json.has("params") && json.get("params").isJsonObject()
          ? json.getAsJsonObject("params")
          : json;
      return (director, seed) -> {
  ...
  private static class RegisterPopulatorPoolType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "register_populator_pool");
    ...
    public SymbolLogic parse(JsonObject json) {
      ...
      return (director, seed) -> {
        ...
        List<Identifier> working = new ArrayList<>(pool);
        ...
        for (int i = 0; i < count; i++) {
          ...
          Identifier popId = working.get(idx);
          if (!allowDuplicates) {
            working.remove(idx);
          }
  ...
  private static class RegisterTerrainAlterationType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "register_terrain_alteration");
    ...
    public SymbolLogic parse(JsonObject json) {
      String rawId = GsonHelper.getAsString(json, "id");
      Identifier altId = Identifier.tryParse(rawId);
      JsonObject params = json.has("params") && json.get("params").isJsonObject()
          ? json.getAsJsonObject("params")
          : json;
      return (director, seed) -> {
  ...
  private static class RegisterTerrainGeneratorType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "register_terrain_generator");
    ...
    public SymbolLogic parse(JsonObject json) {
      String rawId = GsonHelper.getAsString(json, "id");
      Identifier genId = Identifier.tryParse(rawId);
      JsonObject params = json.has("params") && json.get("params").isJsonObject()
          ? json.getAsJsonObject("params")
          : json;
      return (director, seed) -> {
  ...
  private static class RegisterBiomeControllerType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "register_biome_controller");
  ...
  private static class AddBiomeType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "add_biome");
    ...
    public SymbolLogic parse(JsonObject json) {
      ...
      Identifier biomeId = Identifier.tryParse(rawId);
      return (director, seed) -> {
        ...
        server.registryAccess().lookup(Registries.BIOME).ifPresent(registry -> {
          ...
          Holder<Biome> holder = registry.getOrThrow(key);
  ...
  private static class SetOreDisabledType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "set_ore_disabled");
  ...
  private static class SetOresDisabledType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "set_ores_disabled");
  ...
  private static class SetOreMultiplierType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "set_ore_multiplier");
  ...
  private static class SetSecondaryTerrainWeightedType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "set_secondary_terrain_weighted");
  ...
  private static class ColorFromStackType implements SymbolLogicType {
    private final Identifier id = Identifier.fromNamespaceAndPath(Mystcraft.MOD_ID, "set_color_from_stack");
