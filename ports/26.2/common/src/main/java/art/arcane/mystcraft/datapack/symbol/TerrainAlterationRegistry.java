...
public final class TerrainAlterationRegistry {
  ...
  private static final Map<Identifier, TerrainAlterationFactory> FACTORIES = new HashMap<>();

  private TerrainAlterationRegistry() {
  }

  public static void register(Identifier id, TerrainAlterationFactory factory) {
  ...
  public static ITerrainAlteration create(Identifier id, JsonObject json, long seed) {
  ...
  public static Map<Identifier, TerrainAlterationFactory> getAll() {
