...
public final class GrammarRules {
  ...
  public static final Identifier ROOT = asMyst("age");
  public static final Identifier FEATURE_LARGE_EXT = asMyst("feature_large_ext");
  public static final Identifier FEATURE_MEDIUM_EXT = asMyst("feature_medium_ext");
  public static final Identifier FEATURE_SMALL_EXT = asMyst("feature_small_ext");
  public static final Identifier ANGLE_EXT = asMyst("angle_ext");
  public static final Identifier PERIOD_EXT = asMyst("period_ext");
  public static final Identifier PHASE_EXT = asMyst("phase_ext");
  public static final Identifier COLOR_EXT = asMyst("color_ext");
  public static final Identifier GRADIENT_EXT = asMyst("gradient_ext");
  public static final Identifier SUNSET_EXT = asMyst("sunset_ext");

  public static final Identifier BLOCK_NONSOLID = asMyst("block_nonsolid");
  private static final Logger LOGGER = LoggerFactory.getLogger(GrammarRules.class);

  private static final Identifier BIOME_GEN = asMyst("biomes_adv");
  private static final Identifier BIOME_EXT = asMyst("biomes_ext");
  private static final Identifier VISUAL_EFFECT_GEN = asMyst("visuals_adv");
  private static final Identifier VISUAL_EFFECT_EXT = asMyst("visuals_ext");
  private static final Identifier FEATURE_LARGE_GEN = asMyst("feature_large_adv");
  private static final Identifier FEATURE_MEDIUM_GEN = asMyst("feature_medium_adv");
  private static final Identifier FEATURE_SMALL_GEN = asMyst("feature_small_adv");
  private static final Identifier EFFECT_GEN = asMyst("effects_adv");
  private static final Identifier EFFECT_EXT = asMyst("effects_ext");

  private static final Identifier ANGLE_GEN = asMyst("angle_adv");
  private static final Identifier PERIOD_GEN = asMyst("period_adv");
  private static final Identifier PHASE_GEN = asMyst("phase_adv");
  private static final Identifier COLOR_GEN = asMyst("color_adv");
  private static final Identifier GRADIENT_GEN = asMyst("gradient_adv");
  ...
  private static CFGRule buildRule(Integer rank, Identifier parent, Identifier... children) {
    List<Identifier> values = Arrays.asList(children);
