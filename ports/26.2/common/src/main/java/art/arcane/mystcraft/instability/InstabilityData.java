...
public final class InstabilityData {
  ...
  public static void initialize() {
    ...
    ProviderContainer.create("blindness",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.BLINDNESS.value(), 60)),
        Stability.BLINDNESS).add("eating", 1);
    ProviderContainer.create("blindness,g",
        InstabilityProvider.leveled(level -> new EffectPotion(level, true, MobEffects.BLINDNESS.value(), 60)),
        Stability.BLINDNESS_GLOBAL).add("death", 1);

    ProviderContainer.create("fatigue",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.MINING_FATIGUE.value(), 80)),
        Stability.FATIGUE).add("eating", 1);
    ProviderContainer.create("fatigue,g",
        InstabilityProvider.leveled(level -> new EffectPotion(level, true, MobEffects.MINING_FATIGUE.value(), 80)),
        Stability.FATIGUE_GLOBAL).add("death", 1);

    ProviderContainer.create("hunger",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.HUNGER.value(), 80)),
        Stability.HUNGER).add("eating", 1);
    ProviderContainer.create("hunger,g",
        InstabilityProvider.leveled(level -> new EffectPotion(level, true, MobEffects.HUNGER.value(), 80)),
        Stability.HUNGER_GLOBAL).add("death", 1);

    ProviderContainer.create("nausea",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.NAUSEA.value(), 60)),
        Stability.NAUSEA).add("eating", 1);
    ProviderContainer.create("nausea,g",
        InstabilityProvider.leveled(level -> new EffectPotion(level, true, MobEffects.NAUSEA.value(), 60)),
        Stability.NAUSEA_GLOBAL).add("death", 1);

    ProviderContainer.create("poison",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.POISON.value(), 80)),
        Stability.POISON).add("eating", 1);
    ProviderContainer.create("poison,g",
        InstabilityProvider.leveled(level -> new EffectPotion(level, true, MobEffects.POISON.value(), 80)),
        Stability.POISON_GLOBAL).add("death", 1);

    ProviderContainer.create("slow",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.SLOWNESS.value(), 80)),
        Stability.SLOW).add("eating", 1);
    ProviderContainer.create("slow,g",
        InstabilityProvider.leveled(level -> new EffectPotion(level, true, MobEffects.SLOWNESS.value(), 80)),
        Stability.SLOW_GLOBAL).add("death", 1);

    ProviderContainer.create("weakness",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.WEAKNESS.value(), 80)),
        Stability.WEAKNESS).add("eating", 1);
    ProviderContainer.create("weakness,g",
        InstabilityProvider.leveled(level -> new EffectPotion(level, true, MobEffects.WEAKNESS.value(), 80)),
        Stability.WEAKNESS_GLOBAL).add("death", 1);

    ProviderContainer.create("wither",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.WITHER.value(), 30)),
        Stability.WITHER).add("eating", 1);
    ProviderContainer.create("wither,g",
        InstabilityProvider.leveled(level -> new EffectPotion(level, true, MobEffects.WITHER.value(), 30)),
        Stability.WITHER_GLOBAL).add("death", 1);

    ProviderContainer.create("speed",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.SPEED.value(), 600)),
        Stability.HUNGER).add("eating", 1);
    ProviderContainer.create("haste",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.HASTE.value(), 600)),
        Stability.FATIGUE).add("eating", 1);
    ProviderContainer.create("strength",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.STRENGTH.value(), 400)),
        Stability.WEAKNESS).add("eating", 1);
    ProviderContainer.create("jumpboost",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.JUMP_BOOST.value(), 600)),
        Stability.SLOW).add("eating", 1);
    ProviderContainer.create("regen",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.REGENERATION.value(), 200)),
        Stability.POISON).add("eating", 1);
    ProviderContainer.create("resistance",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.RESISTANCE.value(), 300)),
        Stability.WEAKNESS).add("eating", 1);
    ProviderContainer.create("nightvision",
        InstabilityProvider.leveled(level -> new EffectPotion(level, false, MobEffects.NIGHT_VISION.value(), 1200)),
        Stability.BLINDNESS).add("eating", 1);

    ProviderContainer.create("enemyregen,g",
        InstabilityProvider.leveled(level -> new EffectPotionEnemy(level, true, MobEffects.REGENERATION.value(), 200)),
        Stability.ENEMY_REGEN_GLOBAL).add("eating", 1);
    ProviderContainer.create("enemyresist,g",
        InstabilityProvider.leveled(level -> new EffectPotionEnemy(level, true, MobEffects.RESISTANCE.value(), 200)),
    ...
    ProviderContainer.create("crumble",
        InstabilityProvider.repeated(EffectCrumble::new),
