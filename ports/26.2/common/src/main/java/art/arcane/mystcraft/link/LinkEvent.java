...
public abstract class LinkEvent {
  ...
  public static class Alter extends LinkEvent {
     ...
     */
    public void setTargetLevel(@NotNull ServerLevel level) {
      this.targetLevel = Objects.requireNonNull(level, "level");
    }
     ...
     */
    public void setTargetPosition(@NotNull Vec3 position) {
      this.targetPosition = Objects.requireNonNull(position, "position");
    }
