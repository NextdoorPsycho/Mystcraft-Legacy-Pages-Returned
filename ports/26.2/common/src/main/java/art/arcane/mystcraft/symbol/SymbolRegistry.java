...
public final class SymbolRegistry {
  ...
  private static final Map<Identifier, IAgeSymbol> SYMBOLS = new ConcurrentHashMap<>();
  ...
  private static final Set<Identifier> BLACKLIST = ConcurrentHashMap.newKeySet();
  private static final Map<Identifier, IAgeSymbol> STATIC_SYMBOLS = new ConcurrentHashMap<>();
  ...
  private static Identifier getCategoryGrammarToken(SymbolCategory category) {
  ...
  private static void removeInternal(Identifier id) {
   ...
   */
  public static IAgeSymbol get(Identifier id) {
   ...
   * registration.
   */
  public static boolean isStaticSymbol(Identifier id) {
   ...
   */
  public static boolean isOverridden(Identifier id) {
   ...
   */
  public static Identifier mystcraftId(String path) {
