 ...
 * Uses the server's overworld biome source for authentic Minecraft biome
 * distribution.
 */
public class BiomeControllerNative extends BiomeControllerBase {
  ...
  /**
   * Creates a native biome controller. The biome source will be initialized
   * when first queried with a server level.
   */
  ...
  /**
   * Initializes the delegate biome source from a server level. Should be called
