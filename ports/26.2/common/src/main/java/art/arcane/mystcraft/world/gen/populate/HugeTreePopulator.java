...
/**
 * Huge tree populator that generates mega/giant trees. Used when the Huge Trees
 * symbol is applied to an age. Generates large trees in addition to normal tree
 * generation.
 */
