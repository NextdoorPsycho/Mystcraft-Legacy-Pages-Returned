...
public class FolderMenu extends AbstractContainerMenu {
    ...
    public FolderMenu(int containerId, Inventory playerInventory, int folderSlot) {
        ...
        for (int row = 0; row < 2; row++) {
            for (int col = 0; col < 8; col++) {
                ...
                addSlot(new SlotItemHandler(folderInventory, slotIndex, 17 + col * 18, 18 + row * 18) {
                    @Override
     ...
     */
    private static class FolderInventoryHandler extends ItemStackHandler {
        ...
        public void saveToFolder() {
            java.util.ArrayList<ItemStack> pages = new java.util.ArrayList<>();
