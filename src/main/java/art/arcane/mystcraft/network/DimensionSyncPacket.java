...
public class DimensionSyncPacket {
    ...
    public static void handle(DimensionSyncPacket packet, CustomPayloadEvent.Context ctx) {
        ctx.enqueueWork(() -> {
    ...
    public static class DimensionEntry {
        public final int ageUID;
        public final ResourceLocation dimensionId;
        public final String ageName;
        public final boolean isUnstable;

        public DimensionEntry(int ageUID, ResourceLocation dimensionId, String ageName, boolean isUnstable) {
            this.ageUID = ageUID;
