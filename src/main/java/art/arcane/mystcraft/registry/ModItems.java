...
public final class ModItems {
    ...
    public static final RegistryObject<Item> INK_BUCKET =
            MystcraftRegistries.ITEMS.register("ink_bucket",
                    () -> new BucketItem(ModFluids.BLACK_INK_SOURCE,
                            new Item.Properties().stacksTo(1).craftRemainder(Items.BUCKET)));

    // Block items - auto-generated for each block
    public static final RegistryObject<Item> INK_MIXER_ITEM = blockItem("blockinkmixer", ModBlocks.INK_MIXER);
    public static final RegistryObject<Item> BOOK_BINDER_ITEM = blockItem("blockbookbinder", ModBlocks.BOOK_BINDER);
    public static final RegistryObject<Item> BOOK_RECEPTACLE_ITEM = blockItem("blockbookreceptacle", ModBlocks.BOOK_RECEPTACLE);
    public static final RegistryObject<Item> BOOKSTAND_ITEM = blockItem("blockbookstand", ModBlocks.BOOKSTAND);
    public static final RegistryObject<Item> LECTERN_ITEM = blockItem("blocklectern", ModBlocks.LECTERN);
    public static final RegistryObject<Item> LINK_MODIFIER_ITEM = blockItem("blocklinkmodifier", ModBlocks.LINK_MODIFIER);
    public static final RegistryObject<Item> WRITING_DESK_ITEM = blockItem("writingdesk", ModBlocks.WRITING_DESK);
    public static final RegistryObject<Item> CRYSTAL_ITEM = blockItem("blockcrystal", ModBlocks.CRYSTAL);
    public static final RegistryObject<Item> DECAY_ITEM = blockItem("blockdecay", ModBlocks.DECAY);
